...
1) スクリプトデータファイルをダウンロード 
   ...
   - 前処理（オプショナル）を試す場合は、以下の注意もご覧ください。

2) ファイルを配置
   - data_info.mdの[[WHERE TO PUT DATA](https://github.com/nomotom/linkjpc2/blob/main/docs/data_info.md#where-to-put-data)]で指定されたディレクトリに配置してください。
