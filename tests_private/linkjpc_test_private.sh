...
out_dir_base="${base_dir}test_out/exp/"


# 1/13
python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}wlink_r_attr_w_al_am_bl_w/ --mod w -f ab --wlink r -ar_tgt w -al am -bl_tgt w
...
#python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}l_06__slink__mint_e_attr_w/ --mod l:s:m --mint e -l_min 0.6
##
...
##  AIPRB_SMW 別版 (- wlink f) +l06 + wlink l
## herehere
#python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}slink_05_mid__mint_e__wlink_rpl_bca_005_l_06_attr_w_al_am_bl_w/ --mod s:m:lw -f ab --mint e -s_min 0.5 -s_prb mid --wlink rpl -wl_bca r -wl_bca_ratio 0.05 -ar_tgt w -al am -bl_tgt w -l_min 0.6
#python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}slink_05_mid__mint_e__wlink_rpl_bca_01_l_06_attr_w_al_am_bl_w/ --mod s:m:lw -f ab --mint e -s_min 0.5 -s_prb mid --wlink rpl -wl_bca r -wl_bca_ratio 0.1 -ar_tgt w -al am -bl_tgt w -l_min 0.6
#python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}slink_05_mid__mint_e__wlink_rpl_bca_02_l_06_attr_w_al_am_bl_w/ --mod s:m:lw -f ab --mint e -s_min 0.5 -s_prb mid --wlink rpl -wl_bca r -wl_bca_ratio 0.2 -ar_tgt w -al am -bl_tgt w -l_min 0.6
#
##ablation
...
#####m/t+ sw
#### 結果が異なるもの ここから
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_frp/ --mod msw -f n --mint e -s_min 0.5 --wlink frp
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_e_slink_05_wlink_frp/ --mod mtsw -f n --mint e --tinm e -s_min 0.5 --wlink frp
### python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_e_trim_slink_05_wlink_frp/ --mod mtsw -f n --mint e --tinm e -tmt trim -s_min 0.5 --wlink frp
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_p_slink_05_wlink_frp/ --mod msw -f n --mint p -s_min 0.5 --wlink frp
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_p_tinm_p_slink_05_wlink_frp/ --mod mtsw -f n --mint p --tinm p -s_min 0.5 --wlink frp
#### ここまで
####
#####m/t + swl
#### 結果が異なるもの ここから
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_frp_l_06/ --mod mswl -f n --mint e -s_min 0.5 --wlink frp -l_min 0.6
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_e_slink_05_wlink_frp_l_06/ --mod mtswl -f n --mint e --tinm e -s_min 0.5 --wlink frp -l_min 0.6
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_e_trim_slink_05_wlink_frp_l_06/ --mod mtswl -f n --mint e --tinm e -tmt trim -s_min 0.5 --wlink frp -l_min 0.6
### python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_p_slink_05_wlink_frp_l_06/ --mod mswl -f n --mint p -s_min 0.5 --wlink frp -l_min 0.6
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_p_tinm_p_slink_05_wlink_frp_l_06/ --mod mtswl -f n --mint p --tinm p -s_min 0.5 --wlink frp -l_min 0.6
### ここまで
###
#########
#### FINAL
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_p_trim_tinm_p_trim/ --mod mt --mint p -tmm trim --tinm p -tmt trim -f n
####
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}slink_05/ --mod s -s_min 0.5 -f n
...
#####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}slink_05_mint_e_l__tinm_p_wlink_frp_attr_w_al_am_bl_w/ --mod sml:tw -f ab --mint e --tinm p -s_min 0.5 --wlink frp -ar_tgt w -al am -bl_tgt w
####
#####smw **
#####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}slink_05__mint_e__wlink_rp_attr_w_al_am_bl_w/ --mod s:m:w -f ab --mint e -s_min 0.5 --wlink rp -ar_tgt w -al am -bl_tgt w
...
####
#####smlw
#####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}slink_05_mint_e_l__wlink_frp_tinm_p_attr_w_al_am_bl_w/ --mod sml:w:t -f ab --mint e --tinm p -s_min 0.5 --wlink frp -ar_tgt w -al am -bl_tgt w
####
#####smtw
...
##############
####frp
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_frp_attr_w_al_am_bl_w/ --mod msw -f ab --mint e -s_min 0.5 --wlink frp -ar_tgt w -al am -bl_tgt w
####latest0929#python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_frp_l_attr_w_al_am_bl_w/ --mod mswl -f ab --mint e -s_min 0.5 --wlink frp -ar_tgt w -al am -bl_tgt w
###
####here
####retry
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_frp_attr_w_al_am_bl_w_incl_w_imax5_if/ --mod msw -f abi --mint e -s_min 0.5 --wlink frp -ar_tgt w -al am -bl_tgt w -i_tgt w -i_max 5 -i_type f
###
###
####priority
###
...
###
####swm
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}slink_05_mid__wlink_frp__mint_e_attr_w_al_am_bl_w_incl_w_imax5_if/ --mod s:w:m -f abi --mint e -s_min 0.5 -s_prb mid --wlink frp -ar_tgt w -al am -bl_tgt w -i_tgt w -i_max 5 -i_type f
###
####wsm
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}wlink_frp__slink_05_mid__mint_e_attr_w_al_am_bl_w_incl_w_imax5_if/ --mod w:s:m -f abi --mint e -s_min 0.5 -s_prb mid --wlink frp -ar_tgt w -al am -bl_tgt w -i_tgt w -i_max 5 -i_type f
###
####smwt
...
###
###
####latest0929#python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_frp_attr_w_bl_w/ --mod msw -f ab --mint e -s_min 0.5 --wlink frp -ar_tgt w -bl_tgt w
####latest0929#python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_frp_l_attr_w_bl_w/ --mod mswl -f ab --mint e -s_min 0.5 --wlink frp -ar_tgt w -bl_tgt w
####
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_frp_attr_w_bl_w_incl_w_imax5_if/ --mod msw -f abi --mint e -s_min 0.5 --wlink frp -ar_tgt w -bl_tgt w -i_tgt w -i_max 5 -i_type f
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_frp_l_attr_w_bl_w_incl_w_imax5_if/ --mod mswl -f abi --mint e -s_min 0.5 --wlink frp -ar_tgt w -bl_tgt w -i_tgt w -i_max 5 -i_type f
####
#####rp
...
#####
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_rp_attr_w_al_am_bl_w_incl_w_imax5_if/ --mod msw -f abi --mint e -s_min 0.5 --wlink rp -ar_tgt w -al am -bl_tgt w -i_tgt w -i_max 5 -i_type f
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_rp_l_attr_w_al_am_bl_w_incl_w_imax5_if/ --mod mswl -f abi --mint e -s_min 0.5 --wlink rp -ar_tgt w -al am -bl_tgt w -i_tgt w -i_max 5 -i_type f
#####
...
#####
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_rp_attr_w_bl_w_incl_w_imax5_if/ --mod msw -f abi --mint e -s_min 0.5 --wlink rp -ar_tgt w -bl_tgt w -i_tgt w -i_max 5 -i_type f
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_slink_05_wlink_rp_l_attr_w_bl_w_incl_w_imax5_if/ --mod mswl -f abi --mint e -s_min 0.5 --wlink rp -ar_tgt w -bl_tgt w -i_tgt w -i_max 5 -i_type f
####
...
#####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_e_trim_slink_05_wlink_frp_attr_tw_al_am_bl_tw_incl_tw_imax5_if/ --mod mtsw -f abi --mint e --tinm e -tmt trim -s_min 0.5 --wlink frp -ar_tgt tw -al am -bl_tgt tw -i_tgt tw -i_max 5 -i_type f
####
#####from here(sample)
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_e_trim_slink_05_wlink_frp_attr_tw_al_am_bl_tw_incl_tw_imax5_if/ --mod mtsw -f abi --mint e --tinm e -tmt trim -s_min 0.5 --wlink frp -ar_tgt tw -al am -bl_tgt tw -i_tgt tw -i_max 5 -i_type f
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_e_trim_slink_05_wlink_frp_attr_tw_al_am_bl_tw_incl_tw_imax5_of/ --mod mtsw -f abi --mint e --tinm e -tmt trim -s_min 0.5 --wlink frp -ar_tgt tw -al am -bl_tgt tw -i_tgt tw -i_max 5 -i_type o
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_e_trim_slink_05_wlink_frp_l_attr_tw_al_am_bl_tw_incl_tw_imax5_if/ --mod mtswl -f abi --mint e --tinm e -tmt trim -s_min 0.5 --wlink frp -ar_tgt tw -al am -bl_tgt tw -i_tgt tw -i_max 5 -i_type f
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_e_trim_slink_05_wlink_frp_l_attr_tw_al_am_bl_tw_incl_tw_imax5_of/ --mod mtswl -f abi --mint e --tinm e -tmt trim -s_min 0.5 --wlink frp -ar_tgt tw -al am -bl_tgt tw -i_tgt tw -i_max 5 -i_type o
####
######mint_e_tinm_p, frp
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_p_slink_05_wlink_frp_attr_w_al_am_bl_tw_incl_w_imax5_if/ --mod mtsw -f abi --mint e --tinm p -s_min 0.5 --wlink frp -ar_tgt w -al am -bl_tgt tw -i_tgt w -i_max 5 -i_type f
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_p_slink_05_wlink_frp_attr_w_al_am_bl_tw_incl_w_imax5_of/ --mod mtsw -f abi --mint e --tinm p -s_min 0.5 --wlink frp -ar_tgt w -al am -bl_tgt tw -i_tgt w -i_max 5 -i_type o
####
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_p_slink_05_wlink_frp_l_attr_w_al_am_bl_tw_incl_w_imax5_if/ --mod mtswl -f abi --mint e --tinm p -s_min 0.5 --wlink frp -ar_tgt w -al am -bl_tgt tw -i_tgt w -i_max 5 -i_type f
...
###python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_tinm_p_slink_05_wlink_frp_l_attr_w_bl_tw_incl_w_imax5_if/ --mod mtsw -f abi --mint e --tinm p -s_min 0.5 --wlink frp -ar_tgt w -bl_tgt tw -i_tgt w -i_max 5 -i_type f
######
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_trim_tinm_e_slink_05_wlink_frp_attr_mw_al_am_bl_tw_incl_tw_imax_if/ --mod mtsw -f abi --mint e --tinm e -tmm trim -s_min 0.5 --wlink frp -ar_tgt mw -al am -bl_tgt tw -i_tgt tw -i_max 5 -i_type f
####
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_trim_tinm_e_slink_05_wlink_frp_l_attr_mw_al_am_bl_tw_incl_tw_imax5_if/ --mod mtswl -f abi --mint e --tinm e -tmm trim -s_min 0.5 --wlink frp -ar_tgt mw -al am -bl_tgt tw -i_tgt tw -i_max 5 -i_type f
####
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_trim_tinm_e_slink_05_wlink_rp_attr_mw_al_am_bl_tw_incl_tw_imax5_if/ --mod mtsw -f abi --mint e --tinm e -tmm trim -s_min 0.5 --wlink rp -ar_tgt mw -al am -bl_tgt tw -i_tgt tw -i_max 5 -i_type f
####
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_trim_tinm_e_slink_05_wlink_rp_l_attr_mw_al_am_bl_tw_incl_tw_imax5_if/ --mod mtswl -f abi --mint e --tinm e -tmm trim -s_min 0.5 --wlink rp -ar_tgt mw -al am -bl_tgt tw -i_tgt tw -i_max 5 -i_type f
####
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_trim_tinm_p_slink_05_wlink_frp_attr_mw_bl_tw_incl_w_imax5_if/ --mod mtsw -f abi --mint e --tinm p -tmm trim -s_min 0.5 --wlink frp -ar_tgt mw -bl_tgt tw -i_tgt w -i_max 5 -i_type f
#####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_trim_tinm_p_slink_05_wlink_frp_attr_mtw_bl_tw_incl_w_imax5_if/ --mod mtsw -f abi --mint e --tinm p -tmm trim -s_min 0.5 --wlink frp -ar_tgt mtw -bl_tgt tw -i_tgt w -i_max 5 -i_type f
####
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_trim_tinm_p_slink_05_wlink_frp_l_attr_mw_al_am_bl_tw_incl_w_imax5_if/ --mod mtswl -f abi --mint e --tinm p -tmm trim -s_min 0.5 --wlink frp -ar_tgt mw -al am -bl_tgt tw -i_tgt w -i_max 5 -i_type f
####
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_trim_tinm_p_slink_05_wlink_rp_attr_mw_bl_tw_incl_w_imax5_if/ --mod mtsw -f abi --mint e --tinm p -tmm trim -s_min 0.5 --wlink rp -ar_tgt mw -bl_tgt tw -i_tgt w -i_max 5 -i_type f
####
...
####python $script $common_data_dir $tmp_data_dir $in_dir ${out_dir_base}mint_e_trim_tinm_p_slink_05_wlink_rp_l_attr_mw_al_am_bl_tw_incl_w_imax5_if/ --mod mtswl -f abi --mint e --tinm p -tmm trim -s_min 0.5 --wlink rp -al am -ar_tgt mw -bl_tgt tw -i_tgt w -i_max 5 -i_type f
###
